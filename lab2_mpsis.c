...
__interrupt void Timer_A0(void) {
	...
	case 1:
		LED1_PORT_OUT &= ~LED1_BIT;
		if(blink_phase) 	LED3_PORT_OUT |= LED3_BIT;
		else				LED3_PORT_OUT &= ~LED3_BIT;
		break;
	case 2:
		LED3_PORT_OUT &= ~LED3_BIT;
		if(blink_phase) 	LED1_PORT_OUT |= LED1_BIT;
		else				LED1_PORT_OUT &= ~LED1_BIT;
		break;
	case 3:
		LED1_PORT_OUT |= LED1_BIT;
		LED3_PORT_OUT |= LED3_BIT;
